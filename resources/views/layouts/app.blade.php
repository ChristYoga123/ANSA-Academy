...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="{{ $webResource->getFirstMediaUrl('logo-website') }}" />
    <link rel="icon" type="image/png" sizes="16x16" href="{{ $webResource->getFirstMediaUrl('logo-website') }}" />
